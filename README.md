...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/green-lab-8b36)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/green-lab-8b36
```

A live public deployment of this template is available at [https://green-lab-8b36.templates.workers.dev](https://green-lab-8b36.templates.workers.dev)
